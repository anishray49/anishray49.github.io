...
2. [Tate Module and the Weil Pairing](/files/tate-module-weil-pairing.pdf)
3. [Law of Large Numbers and the Central Limit Theorem in Number Theory](/files/lln-clt-number-theory.pdf)
4. [Homogenization of Convex Integral Functionals Under Weakened Growth Conditions](/files/homogenization-convex-integrals.pdf)
5. [Deep Neural Networks and the Analysis of the Approximation Error](/files/deep-neural-networks-approximation-error.pdf)
6. [Haar Measure and the Fourier Transform on Locally Compact Abelian Groups](/files/haar-measure-fourier-transform-lca.pdf)
7. [A Computational Comparison of Lang--Trotter and Hardy--Littlewood Constants for CM Elliptic Curves](/files/lang-trotter-hardy-littlewood-cm.pdf)
